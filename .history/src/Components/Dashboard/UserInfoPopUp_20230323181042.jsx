          ...
          <div className="offSideBarMain">
            ...
            <div className="LinkBox">
              ...
              <Link to={"/mature-fund"}>
                <div
                  // className={
                  //   pathname === "/mature-fund"
                  //     ? 'active'
                  //     : 'unactive'
                  // }
                >
                  <p  className={
                    pathname === "/mature-fund" ? 'active'
                      : 'unactive'
                  }>Mature Funds</p>
                </div>
              </Link>
              ...
              <Link to={"/current-charge"}>
                <div
                  // className={
                  //   pathname === "/current-charge" ? "active" : 'unactive'
                  // }
                >
                  <p  className={
                    pathname === "/current-charge" ? 'active'
                      : 'unactive'
                  }>Current Charge Back</p>
                </div>
              </Link>
            </div>
          </div>
